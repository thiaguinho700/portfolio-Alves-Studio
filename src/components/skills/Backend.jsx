...
function Backend() {
  ...
  return (
    <div className="skills__content">
      ...
      {language == "Portuguese" ? "Desenvolvedor Backend" : "Backend Developer"}
      </h3>
        ...
        <div className="skills__group">
          <div className="skills__data">
            ...
            <div className="containerSubIcon">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="IconTec" viewBox="0 0 448 512">
                <path
                  fill="#FFD43B"
          ...
          <div className="skills__data">
            ...
            <div className="containerSubIcon">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="IconTec"
                viewBox="0 0 48 48"
                width="48px"
                height="48px"
              >
